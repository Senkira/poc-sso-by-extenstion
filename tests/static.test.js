...
const loadingHtml = fs.readFileSync("public/loading.html", "utf8");
...
assert.match(loadingHtml, /Opening Gemini/);
assert.doesNotMatch(loadingHtml, /<script/i);
...
console.log("PASS cover-tab-reload-and-single-gemini-contract");
