...
หลังส่ง password ระบบตั้ง MV3 alarm ห้านาที หาก Google ไม่ไปถึง Gemini และยืนยันบัญชีเป้าหมายภายในเวลา ระบบปิด hidden window ด้วย `AUTH_TIMEOUT` แทนการค้างเงียบ
...
1. ดาวน์โหลด `gemini-extension-agent-poc-v0.12.1.zip` จากหน้า Production แล้วแตกไฟล์
