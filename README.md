...
1. ดาวน์โหลด ZIP จาก <https://poc-after-sso-login-gemini.web.app/downloads/gemini-sso-launcher-extension-v0.4.7.zip> และแตกไฟล์
...
2. ติดตั้ง extension v0.4.7 จาก hosted ZIP
