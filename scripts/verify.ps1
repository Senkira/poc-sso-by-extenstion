...
if ($manifest.version -ne '0.9.0') { throw 'Unexpected extension version.' }
...
if ($html -notmatch '/app.js\?v=0\.9\.0' -or $html -notmatch '/styles.css\?v=0\.9\.0') { throw 'Hosted assets are not cache-busted.' }
