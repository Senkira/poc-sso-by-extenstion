...
if ($manifest.version -ne '0.13.0') { throw 'Unexpected extension version.' }
...
if ($html -notmatch '/app.js\?v=0\.13\.0' -or $html -notmatch '/styles.css\?v=0\.13\.0') { throw 'Hosted assets are not cache-busted.' }
