...
if ($manifest.version -ne '0.13.5') { throw 'Unexpected extension version.' }
...
if ($html -notmatch '/app.js\?v=0\.13\.5' -or $html -notmatch '/styles.css\?v=0\.13\.5') { throw 'Hosted assets are not cache-busted.' }
