...
if ($manifest.version -ne '0.9.1') { throw 'Unexpected extension version.' }
...
if ($html -notmatch '/app.js\?v=0\.9\.1' -or $html -notmatch '/styles.css\?v=0\.9\.1') { throw 'Hosted assets are not cache-busted.' }
