...
if ($manifest.version -ne '0.12.2') { throw 'Unexpected extension version.' }
...
if ($html -notmatch '/app.js\?v=0\.12\.2' -or $html -notmatch '/styles.css\?v=0\.12\.2') { throw 'Hosted assets are not cache-busted.' }
